package com.revo.aesrsa.resrsa;
...
public class RSA {
	private static final String  TAG = "revoaesrsa";
	/** 指定key的大小 */
	private static int KEYSIZE = 2048;

	public static final String serverPrivateKey = "MIIBVgIBADANBgkqhkiG9w0BAQEFAASCAUAwggE8AgEAAkEAtYp4PvgmaWQpUGAj" +
			"xNAuvhZcg2g4R3NyJ74G/uWwvOad8hIl2/o9y80yemgHw9HmX283F1lrbtalaK7x" +
			"Uw1WCwIDAQABAkARYzrTJSdgrsQ6O4sRfbMMZ83ilCfXyBnl7pBy94LvBKobYKQi" +
			"Q8V9L88H3SDXpjwV1ukRk+YWVks4WHAcIcvBAiEA7cwYFpm7808Zcpyfjj1za6Xv" +
			"FGniDbVkNSQAS8t8vuECIQDDb/gKU+gVgrnbsbrn2qqC4Ntp01CimUDILBAPgOFO" +
	...
	public static boolean checkSign(String content, String sign, String publicKey)
	{
		...
		{
			Log.e(TAG,"checkSign---error:" + e.getMessage());
		}
