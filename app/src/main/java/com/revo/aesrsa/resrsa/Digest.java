...
public class Digest {
	...
	public static String signMD5(String aValue, String encoding) {
		try {
			...
			Log.e(TAG,"signMD5---error:" + e + "--message:" + e.getMessage());
	...
	public static String hmacSign(String aValue) {
		try {
			...
			Log.e(TAG,"hmacSign---error:" + e + "--message:" + e.getMessage());
			return null;
		}
	}
	...
	public static String hmacSHASign(String aValue, String aKey, String encoding) {
		...
		try {
			...
			Log.e(TAG,"hmacSHASign---error:" + e + "--message:" + e.getMessage());
			return null;
		}
		md.update(k_ipad);
		md.update(value);
	...
	public static String digest(String aValue, String encoding) {
		...
		try {
			...
			Log.e(TAG,"digest---error:" + e + "--message:" + e.getMessage());
			return null;
		}
